...
public:
	...
	virtual ~CException() throw() {}; ///< The destructor.
...
public:
	...
	~CMemoryException() throw() {}; ///< The destructor.
};
...
{
	static const char fileOpenError[];
public:
	/**
	...
	~CFileException() throw() {}; ///< The destructor.
};
...
public:
	...
	~CDegenException() throw() {}; ///< The destructor.
};
